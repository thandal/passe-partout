...
#print 'WARNING: using test address version in base58.py'

def hash_160_to_bc_address(h160):
  if not have_crypto:
    return ''
  VERSION = '\x00'  # Normal address
#  VERSION = '\x6f'  # Test address
  vh160 = VERSION + h160
...
if __name__ == '__main__':
  ...
  if 1:
    true_addr = 'n1a44regv5cocoqDgEBtCvf8P6SjDqKyFP'
    true_script = 'dbf89509176a975e41d04cc0af24cfc8de4394a9'
    my_script = bc_address_to_hash_160(true_addr)  # <-- takes hex string!
    print true_script
    print my_script.encode('hex')
    my_addr = hash_160_to_bc_address(true_script.decode('hex'))  # <-- takes bytes
    print true_addr
    print my_addr
